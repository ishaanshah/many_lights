...
/**!
.. _bsdf-DiffuseWithGGX:

Rough conductor material (:monosp:`DiffuseWithGGX`)
---------------------------------------------------
...
.. subfigstart::
.. subfigure:: ../../resources/data/docs/images/render/bsdf_DiffuseWithGGX_copper.jpg
   :caption: Rough copper (Beckmann, :math:`\alpha=0.1`)
.. subfigure:: ../../resources/data/docs/images/render/bsdf_DiffuseWithGGX_anisotropic_aluminium.jpg
   :caption: Vertically brushed aluminium (Anisotropic Beckmann, :math:`\alpha_u=0.05,\ \alpha_v=0.3`)
.. subfigure:: ../../resources/data/docs/images/render/bsdf_DiffuseWithGGX_textured_carbon.jpg
   :caption: Carbon fiber using two inverted checkerboard textures for ``alpha_u`` and ``alpha_v``
.. subfigend::
    :label: fig-bsdf-DiffuseWithGGX
...
.. tabs::
    .. code-tab:: xml
        :name: lst-DiffuseWithGGX-aluminium

        <bsdf type="DiffuseWithGGX">
...
class DiffuseWithGGX final : public BSDF<Float, Spectrum> {
public:
    MI_IMPORT_BASE(BSDF, m_flags, m_components)
    MI_IMPORT_TYPES(Texture, MicrofacetDistribution)

    DiffuseWithGGX(const Properties &props) : Base(props) {
    ...
    std::pair<BSDFSample3f, Spectrum> sample(const BSDFContext &ctx,
        ...
        // Add Color
        weight = color->eval(si, active) * dr::InvPi<Float> * Frame3f::cos_theta(bs.wo) + weight;
    ...
    Spectrum eval(const BSDFContext &ctx, const SurfaceInteraction3f &si,
        ...
        // Add Color
        result = color->eval(si, active) * dr::InvPi<Float> * cos_theta_o + result;
    ...
    std::pair<Spectrum, Float> eval_pdf(const BSDFContext &ctx,
        ...
        // Add Color
        value = color->eval(si, active) * dr::InvPi<Float> * cos_theta_o + value;
...
MI_IMPLEMENT_CLASS_VARIANT(DiffuseWithGGX, BSDF)
MI_EXPORT_PLUGIN(DiffuseWithGGX, "Rough conductor")
